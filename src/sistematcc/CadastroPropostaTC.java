...
public class CadastroPropostaTC extends javax.swing.JInternalFrame {
    
    public CadastroPropostaTC() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Cadastro de proposta de TC");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(campoOrientador, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String orientador = campoOrientador.getText();
        
        if(titulo.isEmpty() || autor.isEmpty() || orientador.isEmpty()) {
            mensagem("Por favor, preencha todos os campos");
        }
        else {
            //procurar se titulo já existe
        }
